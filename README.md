...
### Calendars
  ...
  icon       Icon displayed in selector
  color      Dot and event indicator color
  priority   Defines dot display order
...
### Backgrounds
  ...
  Option     Description
  ---------- -------------------------
  card       Entire card background
  selector   Calendar selector panel
  month      Month grid section
  events     Event list panel
...
### Events
  ...
  Option       Description
  ------------ ------------------------------------
  max_items    Maximum number of events displayed
  show_more    Show "+N more" indicator
  show_count   Display total event count
...
### Day Tiles
  ...
  Option       Description
  ------------ -------------------------------------
  background   Enable subtle tile background
  today_only   Apply tile background only to today
...
### Ongoing Event (Optional)
  ...
  Option           Description
  ---------------- --------------------------------
  enabled          Enable live ongoing detection
  update_seconds   Refresh interval
  show_progress    Show visual progress overlay
  show_text        Display elapsed/remaining time
  text_mode        `remaining`, `elapsed`, `both` (dont recommend)
